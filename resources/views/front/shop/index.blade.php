<x-front-layout>
    ...
    <div class="min-h-screen bg-slate-50" dir="rtl">
        ...
        @if(!$isStoriesAlias && isset($packages) && $packages->isNotEmpty())
            <section class="border-t border-slate-200 bg-white py-12 sm:py-16" aria-labelledby="packages-title">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="mb-6 flex flex-wrap items-end justify-between gap-4 text-right">
                        <div>
                            ...
                            <p class="mt-2 text-sm text-slate-500">اختر باقة جاهزة بسعر أقل من شراء مكوناتها منفصلة.</p>
                        </div>
                        <a href="{{ route('packages') }}" class="inline-flex rounded-2xl border border-indigo-200 bg-indigo-50 px-5 py-3 text-sm font-black text-indigo-700 transition hover:border-indigo-600 hover:bg-indigo-600 hover:text-white">عرض كل الباقات</a>
                    </div>
