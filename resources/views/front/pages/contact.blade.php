                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <div class="flex items-center gap-4 justify-end">
                            <div class="text-right">
                                ...
                                <a href="https://wa.me/201000000000" target="_blank" class="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold px-4 py-2.5 rounded-xl transition text-sm">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <div class="flex items-center gap-4 justify-end">
                            <div class="text-right">
                                ...
                                <a href="mailto:hello@herokid.eg" class="text-indigo-600 font-bold hover:underline">hello@herokid.eg</a>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        ...
                        <div class="flex gap-3 justify-end">
                            <a href="#" class="w-10 h-10 bg-pink-100 hover:bg-pink-500 hover:text-white text-pink-600 rounded-xl flex items-center justify-center transition font-bold text-lg">
                            ...
                            <a href="#" class="w-10 h-10 bg-blue-100 hover:bg-blue-600 hover:text-white text-blue-600 rounded-xl flex items-center justify-center transition font-bold text-lg">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            </a>
                            <a href="#" class="w-10 h-10 bg-red-100 hover:bg-red-600 hover:text-white text-red-600 rounded-xl flex items-center justify-center transition font-bold text-lg">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
                        ...
                        <div class="mt-6 bg-green-50 border border-green-100 rounded-2xl p-5 flex items-center justify-between">
                            <a href="https://wa.me/201000000000?text=مرحبا، أريد الاستفسار عن خدمة HeroKid" target="_blank"
