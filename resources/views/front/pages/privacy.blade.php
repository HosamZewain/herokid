        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="prose prose-slate max-w-none text-right leading-relaxed space-y-8">
                ...
                <section>
                    ...
                    <p class="text-slate-600 mt-3 font-semibold">لن نبيع أو نشارك أو نتاجر ببيانات أطفالكم مع أي طرف ثالث.</p>
                </section>
                ...
                <section>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-5 space-y-3 text-slate-700">
                        ...
                        <ul class="list-disc list-inside space-y-2 mr-4">
                            ...
                            <li>يتم حذف صور الأطفال تلقائياً بعد ٩٠ يوماً من اكتمال الطلب وشحنه.</li>
                            <li>يمكنك طلب حذف صور طفلك في أي وقت عبر التواصل معنا.</li>
                        </ul>
                    </div>
                </section>

                <section>
                    <h2 class="text-2xl font-bold text-slate-900 mb-4">٤. مشاركة البيانات مع أطراف ثالثة</h2>
                ...
                <section>
                    <h2 class="text-2xl font-bold text-slate-900 mb-4">٥. حقوقك</h2>
                ...
                <section>
                    <h2 class="text-2xl font-bold text-slate-900 mb-4">٦. أمان البيانات</h2>
                ...
                <section>
                    <h2 class="text-2xl font-bold text-slate-900 mb-4">٧. تواصل معنا</h2>
