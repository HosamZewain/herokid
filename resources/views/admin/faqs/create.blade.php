<x-admin-layout>
    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-2xl font-bold border-r-4 border-indigo-600 pr-3">إضافة سؤال جديد</h2>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="question" id="question" value="{{ old('question') }}" required
                           ...
                           placeholder="مثال: كم يستغرق إنجاز الطلب؟">
                ...
                <div>
                    ...
                    <textarea name="answer" id="answer" rows="6" required
                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('answer') }}</textarea>
