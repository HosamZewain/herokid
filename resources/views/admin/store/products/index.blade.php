        ...
        <div class="mx-auto max-w-7xl space-y-4 sm:px-6 lg:px-8">
            ...
            <div class="overflow-x-auto rounded-2xl bg-white shadow-sm">
                <table class="min-w-[1100px] divide-y divide-gray-100 text-right text-sm">
                    <thead class="bg-gray-50 text-xs font-bold text-gray-500"><tr><th class="px-4 py-3">المنتج</th><th class="px-4 py-3">التصنيف</th><th class="px-4 py-3">السعر</th><th class="px-4 py-3">المشاهدات</th><th class="px-4 py-3">الكمية المباعة</th><th class="px-4 py-3">التخصيص</th><th class="px-4 py-3">المخزون</th><th class="px-4 py-3">الحالة</th><th class="px-4 py-3">إجراءات</th></tr></thead>
                    <tbody class="divide-y divide-gray-100">
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td class="px-4 py-3 font-bold text-slate-700">{{ number_format($product->sold_quantity) }}</td>
