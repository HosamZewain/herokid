...
@if($messages->isNotEmpty())
    @if($compact)
        <details class="relative" data-whatsapp-messages>
            <summary title="رسائل واتساب" aria-label="رسائل واتساب" class="grid h-8 w-8 cursor-pointer list-none place-items-center rounded-md bg-green-50 text-green-700 hover:bg-green-100 [&::-webkit-details-marker]:hidden">
            ...
            <div class="mt-2 w-48 overflow-hidden rounded-2xl border border-emerald-100 bg-white p-2 text-right shadow-lg">
