                        ...
                        <article class="space-y-4 p-5">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                @if($whatsappNumber && !$group['trashed'])
                                    <a href="https://wa.me/{{ $whatsappNumber }}?text={{ urlencode('مرحباً، بخصوص طلبك '.($group['short_reference'] ?: $group['key'])) }}" target="_blank" rel="noopener" class="rounded-xl bg-green-50 px-3 py-2.5 text-center text-xs font-black text-green-700">واتساب</a>
