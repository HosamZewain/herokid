                    ...
                    <div class="mb-5 flex flex-col gap-4 border-b pb-4 text-right lg:flex-row lg:items-start lg:justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-500">
                                هذا هو المصدر الوحيد لتعليمات إنشاء هوية الطفل في جميع طلبات القصص.
                                بيانات الطفل والقصة والصور الآمنة تضاف تلقائيًا أسفل القالب عند كل عرض أو طلب من الـAPI.
                            </p>
                            @if($setting)
                ...
                <aside class="space-y-6">
                    <section class="rounded-2xl border border-fuchsia-100 bg-fuchsia-50/60 p-5 text-right">
                        ...
                        <ul class="mt-3 space-y-2 text-sm font-bold leading-6 text-fuchsia-900">
                            <li>كل الطلبات القديمة والجديدة ستعرض النسخة الجديدة فورًا.</li>
                            <li>لا يتم تثبيت نسخة من القالب داخل الطلب ولا توجد نسخة خاصة لكل طلب.</li>
                            <li>محاولات الإنتاج المكتملة تحتفظ بسجل التدقيق الخاص بما تم استخدامه، لكنها لا تمنع تحديث برومبت الطلب الحالي.</li>
                    ...
                    <section class="rounded-2xl border border-gray-100 bg-white p-5 text-right">
                        ...
                        <p class="mt-2 text-sm leading-6 text-gray-600">
                            صفحة الطلب والـAgent API يكوّنان البرومبت وقت الطلب من هذا القالب ومن أحدث بيانات الطفل والقصة، لذلك لا تحتاج لتحديث الطلبات يدويًا.
                        </p>
                    </section>
                </aside>
            </div>
