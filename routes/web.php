...
Route::middleware(['auth', 'is_admin', 'admin_audit'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::put('orders/{order}/notes/{note}', [OrderAdminNoteController::class, 'update'])->whereNumber(['order', 'note'])->middleware('permission:orders.notes.edit')->name('orders.notes.update');
    ...
    Route::put('settings/notifications/order-created-template', [NotificationCenterController::class, 'updateOrderCreatedTemplate'])->middleware('permission:settings.notifications.manage')->name('settings.notifications.order-created-template.update');
