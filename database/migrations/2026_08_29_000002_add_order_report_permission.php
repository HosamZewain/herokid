...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $definition = AdminPermissionRegistry::metadata('order_reports.view');
        if (! $definition) {
            return;
        }

        DB::table('permissions')->updateOrInsert(
            ['key' => 'order_reports.view'],
            [
        ...
        $permissionId = DB::table('permissions')->where('key', 'order_reports.view')->value('id');
        if (! $permissionId) {
            return;
        }
    ...
    public function down(): void
    {
        ...
        DB::table('permissions')->where('key', 'order_reports.view')->delete();
    }
};
