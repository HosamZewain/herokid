...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $definition = AdminPermissionRegistry::metadata('sales_reports.view');
        if (! $definition) {
            return;
        }

        DB::table('permissions')->updateOrInsert(
            ['key' => 'sales_reports.view'],
            [
        ...
        $permissionId = DB::table('permissions')->where('key', 'sales_reports.view')->value('id');
        if (! $permissionId) {
            return;
        }
    ...
    public function down(): void
    {
        ...
        DB::table('permissions')->where('key', 'sales_reports.view')->delete();
    }
};
