...
JSON,
        ...
        'identity.confirm' => [
            ...
            'description_ar' => 'يُستدعى بعد إنشاء هوية الطفل، لعرضها على العميل ليعتمدها أو يطلب تعديلها. الإجراء (procedure) في RoboDesk هو ما يكمل المحادثة بعد الاعتماد — طلب الدفع واستلام الإثبات — ولا يرسل HeroKid رسالة دفع منفصلة.',
